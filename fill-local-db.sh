...
register_device "AA:99:77:22:12:AA" "dht-light" '[
  { "type": "sensor", "name": "temperature", "enable": true, "order": 1, "unit": "\u00b0C", "spec": { "format": "float", "min": -40, "max": 80, "step": 0.1 } },
  { "type": "sensor", "name": "humidity", "enable": true, "order": 2, "unit": "%", "spec": { "format": "float", "min": 0, "max": 100, "step": 0.1 } },
...
register_device "BB:99:77:22:12:04" "airquality-pir" '[
  ...
  { "type": "sensor", "name": "airquality", "enable": true, "order": 2, "unit": "-", "spec": { "format": "int", "min": 0, "max": 500, "step": 1 } }
]'

register_device "CC:99:77:22:12:05" "barometer" '[
  { "type": "sensor", "name": "airpressure", "enable": true, "order": 1, "unit": "hPa", "spec": { "format": "float", "min": 800, "max": 1200, "step": 0.1 } }
]'
...
register_device "EE:02:55:99:99:01" "ac-lg" '[
  ...
  { "type": "controller", "name": "setpoint", "enable": true, "order": 2, "unit": "\u00b0C", "spec": { "format": "float", "min": 16, "max": 30, "step": 0.5 } },
  { "type": "controller", "name": "mode", "enable": true, "order": 3, "unit": "-", "spec": { "format": "list", "list": [ { "value": 0, "text": "auto" }, { "value": 1, "text": "cool" }, { "value": 2, "text": "heat" }, { "value": 3, "text": "dry" }, { "value": 4, "text": "fan" } ] } },
  { "type": "controller", "name": "fanSpeed", "enable": true, "order": 4, "unit": "-", "spec": { "format": "list", "list": [ { "value": 0, "text": "auto" }, { "value": 1, "text": "low" }, { "value": 2, "text": "medium" }, { "value": 3, "text": "high" } ] } }
]'
...
register_device "00:90:33:77:22:03" "thermostat" '[
  { "type": "controller", "name": "setpoint", "enable": true, "order": 1, "unit": "\u00b0C", "spec": { "format": "float", "min": 5, "max": 35, "step": 0.5 } },
  { "type": "controller", "name": "tolerance", "enable": true, "order": 2, "unit": "\u00b0C", "spec": { "format": "float", "min": 0.1, "max": 5, "step": 0.1 } },
  { "type": "sensor", "name": "temperature", "enable": true, "order": 3, "unit": "\u00b0C", "spec": { "format": "float", "min": -40, "max": 80, "step": 0.1 } }
]'
